	...
	return (
		<>
			...
			<p>
				...
				https://authenticator-esn.herokuapp.com, you are agreeing to be bound by
			...
			<p>
				This will let EK Solutions to terminate upon violations of any of these
			...
			<p>
				EK Solutions or its suppliers will not be hold accountable for any
				damages that will arise with the use or inability to use the materials
				on EK Solutions’s Website, even if EK Solutions or an authorize
			...
			<p>
				The materials appearing on EK Solutions’s Website may include technical,
				typographical, or photographic errors. EK Solutions will not promise
				that any of the materials in this Website are accurate, complete, or
				current. EK Solutions may change the materials contained on its Website
				at any time without notice. EK Solutions does not make any commitment to
			...
			<p>
				EK Solutions has not reviewed all of the sites linked to its Website and
				is not responsible for the contents of any such linked site. The
				presence of any link does not imply endorsement by EK Solutions of the
			...
			<p>
				EK Solutions may revise these Terms of Use for its Website at any time
